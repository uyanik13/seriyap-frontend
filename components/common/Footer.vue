...
<template>
  <footer class="bg-white pt-4 pb-8 dark:bg-gray-800 xl:pt-8">
    <div
      class="mx-auto max-w-screen-lg px-4 text-gray-400 dark:text-gray-300 sm:px-6 md:px-8 xl:max-w-screen-xl"
    >
      <ul class="flex flex-wrap justify-center pb-8 text-sm text-gray-500">
        <li class="w-1/2 md:w-1/3 lg:w-1/3">
          <div class="text-center">
            <h2 class="text-md mb-4 uppercase text-gray-500 dark:text-gray-200">
              BİLGİ
            </h2>
            <ul>
              <li
              ...
              >
                <NuxtLink to="/nasil-kullanilir"> Nasil Kullanilir? </NuxtLink>
              </li>
              <li
                class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
              >
                <NuxtLink to="/hakkimizda">
                  {{ $t("components.footer.hakkimizda") }}
                </NuxtLink>
              </li>
              <li
                class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
      ...
      <div
        class="mx-auto flex max-w-xs items-center justify-between border-t border-gray-200 pt-8"
      >
        <a href="#">
          <svg
            width="20"
      ...
      <div
        class="flex items-center justify-center pt-10 text-center font-light sm:pt-12"
      >
